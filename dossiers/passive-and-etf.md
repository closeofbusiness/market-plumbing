...
The passive bid and ETF creation, as argued by Michael Green, are a large part of why equity prices rose: a buyer who does not look at price, meeting a shrinking float.

## Status

**Sized as a measurement. Failed as a causal price impact.** Green’s claims are hypotheses. The measurement that survived is about wrappers and supply, not about a multiplier.
...
A design that identifies passive demand without borrowing a multiplier, and that clears a minimum detectable effect before it is run. A holder-side split that shows the ETF-versus-mutual-fund offset is the same capital. Neither exists on free data today.

## Data used

Z.1 F.223 / L.223 and the ETF instrument lines, ICI Fact Book Table 13 as the corroboration named in the answer (match to under $0.1bn on 2024 and 2025), N-PORT for the closed mega-firm test, leveraged-ETF AUM from issuer files for the Green remainder.
