...
- **Correct position:** the proceeding is **stayed until roughly 12–13 November 2026**. The three pre-registered panel positions **cannot resolve** — the resolving event was deferred, not decided. Panel lens D's first leg did **not** fire.
